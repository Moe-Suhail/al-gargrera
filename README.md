...
تطبيق ويب خاص لتسجيل التعاملات الشخصية بين أخوين. التطبيق لا يحوّل أموالًا ولا يعمل كبنك أو نظام محاسبة؛ هو فقط يسجل العمليات، السداد، التأكيدات، الرصيد، العملات، الإيصالات، والنشاط.
...
- المستخدم يرى فقط المساحة المشتركة التي هو عضو فيها.
